...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-4">
            <img src="{{ $book->cover_url ?? 'https://via.placeholder.com/300x400' }}" class="img-fluid rounded shadow" alt="{{ $book->title }}">
        </div>
        <div class="col-md-8">
            ...
            <div class="mb-3">
                <p class="text-muted mb-1">Kode Buku</p>
                <p class="h5">{{ $book->code }}</p>
            </div>
