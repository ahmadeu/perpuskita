...
<div class="container mt-4">
    ...
    <form action="{{ route('informasi.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="slug" class="form-control" required placeholder="profil, standar-pelayanan, dst">
        </div>
        <div class="mb-3">
            <label for="konten" class="form-label">Konten</label>
            <textarea name="konten" class="form-control" id="konten" rows="8"></textarea>
        </div>
