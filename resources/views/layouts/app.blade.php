...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-xl navbar-light bg-white">
            <div class="container">
                ...
                <a class="navbar-brand text-primary" href="#">
                    <img src="/images/lambangumku.png" alt="Logo"
                        style="height: 28px; width: 28px; object-fit: contain; display: inline-block; vertical-align: middle; margin-right: 8px;">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        @auth
                            ...
                            @elseif(auth()->user()->role === 'user')
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->routeIs('user.borrowings') ? 'active' : '' }}"
        ...
        <main class="py-4">
            <div class="container">
                    @if (request()->routeIs('dashboard') || request()->routeIs('informasi.profil') || request()->routeIs('informasi.standarPelayanan') || request()->routeIs('informasi.waktuPelayanan') || request()->routeIs('informasi.pustakawan'))
                        <div class="mb-3">
        ...
        <!-- Footer -->
        @if (request()->routeIs('welcome') ||  auth()->check() && auth()->user()->role === 'user')
            <footer class="bg-primary text-white text-center py-5">
                <div class="container">
                    <div class="row text-start">
                        <div class="col-md-4 mb-4">
                            <h5>Tentang Kami</h5>
                            <p>Perpustakaan Universitas Muhammadiyah Kudus menyediakan koleksi buku digital untuk
                                mendukung pembelajaran mahasiswa.</p>
                        </div>
                        <div class="col-md-4 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mt-3">
                                <div class="map-container"
                                    style="position: relative; width: 100%; padding-bottom: 56.25%; height: 0; border-radius: 10px; overflow: hidden; border: 2px solid rgba(255,255,255,0.3);">
                                    <iframe
                                        src="https://www.google.com/maps?q=Universitas+Muhammadiyah+Kudus,+Jl.+Ganesha+Raya+No.+1,+Kudus,+Jawa+Tengah&hl=id&z=17&output=embed"
                                        width="100%" height="100%"
                                        style="position:absolute;top:0;left:0;border:0;" allowfullscreen=""
                                        loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                                        title="Lokasi Universitas Muhammadiyah Kudus"></iframe>
                                    <a href="https://www.google.com/maps/search/?api=1&query=Universitas+Muhammadiyah+Kudus,+Jl.+Ganesha+Raya+No.+1,+Kudus,+Jawa+Tengah"
                                        target="_blank"
                                        style="position:absolute;top:0;left:0;width:100%;height:100%;z-index:2;"
                                        title="Buka di Google Maps"></a>
                                </div>
                            </div>
                        </div>
                    </div>
