        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <a href="{{ route('books.index') }}"
                    class="card bg-primary text-white card-link-hover text-decoration-none">
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <a href="{{ route('users.index') }}"
                    class="card bg-success text-white card-link-hover text-decoration-none">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
            ...
            <div class="col-md-3">
                <a href="{{ route('borrowings.index') }}"
                    class="card bg-warning text-white card-link-hover text-decoration-none">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
            ...
            <div class="col-md-3">
                <a href="#"
                    class="card bg-danger text-white card-link-hover text-decoration-none">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
